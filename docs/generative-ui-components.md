...
O sistema implementa **UI Generativa** onde componentes React são criados dinamicamente pelo agente LangGraph e streamados em tempo real para o frontend. Cada tool retorna não apenas dados, mas também a especificação completa do componente UI que deve renderizá-los.
